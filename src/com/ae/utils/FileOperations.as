...
public class FileOperations extends EventDispatcher
{
	...
	public function setBrowseFolder(newFolder:File):void
	{
	...
	/**
	 * This method will be invoked when a directory is to be selected
	 */
	private function onDirectorySelect(event:Event):void
	{
		file.removeEventListener(Event.SELECT, onDirectorySelect);
		selectedFile = event.target as File;
		dispatchEvent(new Event("complete"));
	}
